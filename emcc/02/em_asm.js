...
var ASM_CONSTS = {
  68880: () => { console.log('你好,js'); console.log('你好,window', window); },  
 68944: ($0, $1, $2) => { return $0 + $1 + $2; },  
 68969: ($0) => { console.log('sum: ', $0); },  
 68999: ($0, $1) => { console.log('double: ', $0, $1); },  
 69036: () => { return 567 },  
 69047: () => { return 3.14159 }
};
